...
export const TechSpecs: React.FC = () => {
    ...
    return (
        <section className="py-24 bg-zinc-950 border-b border-white/20 relative overflow-hidden">
            ...
            <div className="px-4 md:px-12 max-w-[90rem] mx-auto relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-white/20 pb-8">
                    ...
                    <div className="text-right">
                        <div className="text-4xl font-mono text-white font-bold">100<span className="text-zinc-500 text-lg">/100</span></div>
                        <div className="text-zinc-400 text-xs uppercase tracking-widest">{t.techSpecs.score}</div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    {t.techSpecs.blocks.map((block, idx) => {
                        ...
                        return (
                            <div key={idx} className="border border-white/20 bg-black/60 backdrop-blur-sm p-8 shadow-[0_0_20px_rgba(255,255,255,0.02)]">
                                ...
                                <ul className="space-y-4 font-mono text-sm text-zinc-300">
                                    {block.items.map((item, i) => (
                                        <li key={i} className={`flex justify-between ${i !== block.items.length - 1 ? 'border-b border-white/10 pb-2' : 'pt-2'}`}>
                ...
                <div className="mt-8 p-4 border border-white/20 bg-zinc-900/50 backdrop-blur-sm font-mono text-xs text-zinc-400 uppercase flex items-center gap-4">
